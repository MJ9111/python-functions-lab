...
product = lambda *args: args[0] * product(*args[1:]) if len(args) > 1 else args[0]
...
basicCalculator = lambda a, b, operation: a + b if operation == 'add' else a - b if operation == 'subtract' else a * b if operation == 'multiply' else a / b
